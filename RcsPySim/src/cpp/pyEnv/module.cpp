...
PYBIND11_MODULE(_rcsenv, m)
{
    ...
    py::class_<Rcs::BoxSpace>(m, "BoxSpace")
        .def_property_readonly("min", &Rcs::BoxSpace::getMin, py::return_value_policy::reference_internal).def_property_readonly(
    ...
    .def("step", &Rcs::RcsSimEnv::step, py::arg("action"), py::arg("disturbance") = py::none(), py::call_guard<py::gil_scoped_release>())
    ...
    .def("getBodyPosition", [](Rcs::RcsSimEnv& self, const char* bodyName, const char* refBodyName, const char* refFrameName)
    {
    ...
    .def_property_readonly("lastObservation", &Rcs::RcsSimEnv::getCurrentObservation, py::return_value_policy::copy);
