 ...
 */
static bool getMatrixProperty(Eigen::MatrixXd& out, PropertySource* ps, const char* property, unsigned int expectedRows,
...
void DSMassSpringDamper::step(Eigen::VectorXd& x_ddot, const Eigen::VectorXd& x_dot, const Eigen::VectorXd& x,
                              double dt) const
{
 ...
 */
DSMassSpringDamperNonlinear::DSMassSpringDamperNonlinear(const DSMassSpringDamper::Spring& attractor,
...
void DSMassSpringDamperNonlinear::step(Eigen::VectorXd& x_ddot, const Eigen::VectorXd& x_dot, const Eigen::VectorXd& x,
                                       double dt) const
{
    Eigen::VectorXd sumSprings = Eigen::VectorXd::Zero(x.size()); // sums attractors and repellers
