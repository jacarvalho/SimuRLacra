...
public:
     ...
     * We store the desired task space velocity of the DS for potential using it in AMTaskActivation or debugging.
     * */
...
public:
     ...
     */
    DSMassSpringDamper(const Spring& attractor, const std::vector<Spring>& repellers, const double damping,
...
public:
     ...
     * @param[in] mass mass of the particle (default: unit mass 1kg)
     */
    DSMassSpringDamperNonlinear(const Spring& attractor, const std::vector<Spring>& repellers, const double damping,
                                const double mass = 1.0);
