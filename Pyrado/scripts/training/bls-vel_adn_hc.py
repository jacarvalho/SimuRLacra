"""
Train an agent to solve the simplified Box Lifting task using Activation Dynamics Networks and Hill Climbing.
"""
import torch as to
...
if __name__ == '__main__':
    ...
    ex_dir = setup_experiment(BoxLiftingSimpleVelMPsSim.name, f'adn-{HCNormal.name}', 'lin', seed=1001)
